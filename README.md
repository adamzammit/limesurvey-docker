...
-	`-e LIMESURVEY_PHP_SESSION_SAVE_HANDLER=...` (defaults to '' - Leave blank or don't set to use default sessions. Set to the desired handler (eg redis, memcached) if you want to specify. Must use in conjuction with LIMESUREVY_PHP_SESSION_SAVE_PATH
-	`-e LIMESURVEY_PHP_SESSION_SAVE_PATH=...` (defaults to '' - Leave blank or don't set to use default sessions. Set to the desired session path if you want to specify. Must use in conjuction with LIMESUREVY_PHP_SESSION_SAVE_HANDLER
